import {map, sort, filter, find, findLast, reverse, head, tail} from '../services/array-functions';
...
// ["Jon","Bob","Ted","Axe"]
describe('filter', () => {
  it('should find all instances of criteria specified', () => {
    expect(filter(names, findThree)).toEqual(['Jon', 'Bob', 'Ted', 'Axe']);
  });
});

// find should find one name of "Barney"
// locates the first occurence of thing
describe('find', () => {
  it('should find single instance of name specified', () => {
...
describe('tail', () => {
  it('should return all elements in array except for first element', () => {
